...
| Placas | Más información | Vínculo FFU | Configuración | Introducción |
|-----------|----------|---------|---------|---------|---------|-------|
...
| [MinnowBoard Turbot](https://minnowboard.org) | [Sitio de Minnowboard](https://minnowboard.org/get-a-board) | [Descargar FFU](https://www.microsoft.com/software-download/windows10IoTCore#!) | [Configuración de un dispositivo MinnowBoard](https://docs.microsoft.com/windows/iot-core/tutorials/minnowboard) | N/A |
