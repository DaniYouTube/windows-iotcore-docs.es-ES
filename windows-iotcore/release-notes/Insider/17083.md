...
---
# <a name="release-notes-for-build-17083"></a>Notas de la versión de la compilación 17083
_Número de compilación 17083. 2018 de febrero_
...
* Modo flash habilitado en imágenes de IOTUAP.


## <a name="additional-information"></a>Información adicional
* La versión de BSP usada para nuestra imagen de la placa de Dragon es 2116.0.0.0 
...
*   Los micrófonos no funcionan.
*   El puntero del mouse no está visible en las imágenes de la placa dragón.
*   No se pueden implementar aplicaciones en modo sin periféricos. El dispositivo no funciona en el modo sin periféricos.
...
*   Las aplicaciones de inicio de UWP se reemplazarán por la aplicación predeterminada de IoT Core.
...
MinnowBoard Max no arrancará a menos que la versión del firmware sea .092 o posterior. La versión mínima recomendada del firmware es "MinnowBoard MAX 0,92 64-bit". Las actualizaciones de firmware pueden descargarse desde [aquí](https://firmware.intel.com/projects/minnowboard-max).
...
Por ejemplo: checknetisolation loopbackexempt-a-n = IoTOnboardingTask-uwp_1w720vyc4ccym reboot. 
...
* [Agregar un archivo y una configuración de registro a una imagen](https://docs.microsoft.com/windows-hardware/manufacture/iot/add-a-registry-setting-to-an-image)
...
* Inicie sesión con SSH o PS, y ejecute este comando para iniciar el FTP:  
  ```
  start ftpd.exe 
  ```
