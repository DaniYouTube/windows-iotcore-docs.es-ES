...
---
# <a name="release-notes-for-build-17686"></a>Notas de la versión de la compilación 17686
_Número de compilación 17686. 2018 de mayo._
...
* Node. js y Python no se pueden usar en aplicaciones de UWP. Es posible que los ejemplos anteriores de estos lenguajes dejen de funcionar correctamente. Microsoft está pensando en alternativas para futuras versiones. 
* El SDK de Cortana no responderá a "Hola Cortana" en MBM 64, QDB. 
* CortanaSDK no devolverá resultados de la búsqueda web. 
* Error al instalar la aplicación de visualización inteligente. 
* MiraCast no puede conectarse al dongle (QDB-> dongle).
* DMDashboard inicia una excepción al intentar leer la información del dispositivo después de la inscripción de Azure.
* OpenSSH no funciona correctamente con IoTCore.
* Los engranajes no giran en el UWF y en las actualizaciones del sistema operativo.
