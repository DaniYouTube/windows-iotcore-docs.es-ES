...
---
# <a name="release-notes-for-build-17692"></a>Notas de la versión de la compilación 17692
_Número de compilación 17692. 2018 de junio._
...
* Se produce un error de incorporación con Hummingboard.
* UP2 no se puede arrancar.
...
`bcdedit /set debug off`p.e. En Windows Device portal/procesos/ejecutar comando, "c:\windows\system32\bcdedit/Set Debug OFF")
