...
---
# <a name="release-notes-for-build-17763253"></a>Notas de la versión de compilación 17763.253
_17763.253 del número de compilación. Febrero de 2019._
...
* La versión BSP usada para nuestra imagen Dragon Board es 2120.0.0.0. 
...
* Configuración de control de brillo no se conserva en IoT durante la invalidación.
...
#### <a name="accessing-public-documents"></a>Obtener acceso a documentos públicos
Se realizó un cambio a las API subyacentes para el acceso de archivo que requiere una aplicación especifique broadFileSystem acceso con el fin de obtener acceso al directorio de documentos públicos.
...
Algunos teclados y ratones USB no funcionen en IoT Core. Usar un teclado o mouse. Encontrará una lista de dispositivos periféricos validados en el [documentación aquí](https://docs.microsoft.com/en-us/windows/iot-core/learn-about-hardware/hardwarecompatlist).
...
* [Agregar un archivo y la configuración del registro a una imagen](https://msdn.microsoft.com/en-us/library/windows/hardware/mt670641(v=vs.85).aspx)
